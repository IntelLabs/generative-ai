...
compatible_versions = ['0.0.5_pd230208','0.0.5_pd230228', 'None']
...
automated_task_list = ['Multiple objects', 'Single object','Negation','Counting','Simple arithmetic','Conditional generation']
